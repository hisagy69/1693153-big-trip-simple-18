...
const sortPriceUp = (points) => (points.sort((point1, point2) => (point2.basePrice - point1.basePrice)));

const sortByDate = (points) => (points.sort((point1, point2) => dayjs(point2.dateFrom).diff(dayjs(point1.dateFrom))));
